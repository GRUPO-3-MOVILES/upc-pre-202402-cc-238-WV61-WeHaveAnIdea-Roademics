        ...
        body: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFF0A3D62), Color(0xFF40E0D0)], // MediumTurquoise y Turquoise
              ...
              child: Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: Colors.white.withOpacity(0.5), // Borde blanco semitransparente
                      width: 1.5,
                    ),
                  ),
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: TextButton(
                          ...
                          child: const Text(
                            'Forgot my password',
                            style: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.bold), // Itálica
                          ),
                        ),
                      ),
                      const SizedBox(height: 16.0),
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color.fromARGB(255, 9, 50, 75), // Color del botón
